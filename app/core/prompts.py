...
""".strip()
    ...
    mode_instruction = {
        ...
        "quiz_mc": "Erstelle ein Multiple-Choice-Quiz mit genau einer richtigen Antwort pro Frage. Gib genau 4 Antwortoptionen pro Frage an. Die richtige Antwort darf nicht immer an derselben Position stehen. Verteile die richtigen Antworten über unterschiedliche Positionen (0, 1, 2 oder 3). Mische die Antwortreihenfolge pro Frage neu. Antworte ausschließlich als gültiges JSON im folgenden Format: {\"topic\": \"...\", \"questions\": [{\"question\": \"...\", \"options\": [\"...\", \"...\", \"...\", \"...\"], \"correct_index\": 1}]}. Verwende keine zusätzliche Einleitung und keinen Fließtext außerhalb des JSON.",
